...
Use this skill when the user asks for Word, Excel, PowerPoint, proposal documents, tables, budgets, schedules, meeting summaries, or structured attachments. PPT is always handled by `create_visual_ppt`; `create_office_file` is Word/Excel only.
