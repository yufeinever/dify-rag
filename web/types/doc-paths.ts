...
// UseDify paths
type UseDifyPath =
  | '/use-mmbai/build/additional-features'
  | '/use-mmbai/build/goto-anything'
  | '/use-mmbai/build/mcp'
  | '/use-mmbai/build/orchestrate-node'
  | '/use-mmbai/build/predefined-error-handling-logic'
  | '/use-mmbai/build/shortcut-key'
  | '/use-mmbai/build/version-control'
  | '/use-mmbai/debug/error-type'
  | '/use-mmbai/debug/history-and-logs'
  | '/use-mmbai/debug/step-run'
  | '/use-mmbai/debug/variable-inspect'
  | '/use-mmbai/getting-started/introduction'
  | '/use-mmbai/getting-started/key-concepts'
  | '/use-mmbai/getting-started/quick-start'
  | '/use-mmbai/knowledge/connect-external-knowledge-base'
  | '/use-mmbai/knowledge/create-knowledge/chunking-and-cleaning-text'
  | '/use-mmbai/knowledge/create-knowledge/import-text-data/readme'
  | '/use-mmbai/knowledge/create-knowledge/import-text-data/sync-from-notion'
  | '/use-mmbai/knowledge/create-knowledge/import-text-data/sync-from-website'
  | '/use-mmbai/knowledge/create-knowledge/introduction'
  | '/use-mmbai/knowledge/create-knowledge/setting-indexing-methods'
  | '/use-mmbai/knowledge/external-knowledge-api'
  | '/use-mmbai/knowledge/integrate-knowledge-within-application'
  | '/use-mmbai/knowledge/knowledge-pipeline/authorize-data-source'
  | '/use-mmbai/knowledge/knowledge-pipeline/create-knowledge-pipeline'
  | '/use-mmbai/knowledge/knowledge-pipeline/knowledge-pipeline-orchestration'
  | '/use-mmbai/knowledge/knowledge-pipeline/manage-knowledge-base'
  | '/use-mmbai/knowledge/knowledge-pipeline/publish-knowledge-pipeline'
  | '/use-mmbai/knowledge/knowledge-pipeline/readme'
  | '/use-mmbai/knowledge/knowledge-pipeline/upload-files'
  | '/use-mmbai/knowledge/knowledge-request-rate-limit'
  | '/use-mmbai/knowledge/manage-knowledge/introduction'
  | '/use-mmbai/knowledge/manage-knowledge/maintain-dataset-via-api'
  | '/use-mmbai/knowledge/manage-knowledge/maintain-knowledge-documents'
  | '/use-mmbai/knowledge/metadata'
  | '/use-mmbai/knowledge/readme'
  | '/use-mmbai/knowledge/test-retrieval'
  | '/use-mmbai/monitor/analysis'
  | '/use-mmbai/monitor/annotation-reply'
  | '/use-mmbai/monitor/integrations/integrate-aliyun'
  | '/use-mmbai/monitor/integrations/integrate-arize'
  | '/use-mmbai/monitor/integrations/integrate-langfuse'
  | '/use-mmbai/monitor/integrations/integrate-langsmith'
  | '/use-mmbai/monitor/integrations/integrate-opik'
  | '/use-mmbai/monitor/integrations/integrate-phoenix'
  | '/use-mmbai/monitor/integrations/integrate-weave'
  | '/use-mmbai/monitor/logs'
  | '/use-mmbai/nodes/agent'
  | '/use-mmbai/nodes/answer'
  | '/use-mmbai/nodes/code'
  | '/use-mmbai/nodes/doc-extractor'
  | '/use-mmbai/nodes/http-request'
  | '/use-mmbai/nodes/human-input'
  | '/use-mmbai/nodes/ifelse'
  | '/use-mmbai/nodes/iteration'
  | '/use-mmbai/nodes/knowledge-retrieval'
  | '/use-mmbai/nodes/list-operator'
  | '/use-mmbai/nodes/llm'
  | '/use-mmbai/nodes/loop'
  | '/use-mmbai/nodes/output'
  | '/use-mmbai/nodes/parameter-extractor'
  | '/use-mmbai/nodes/question-classifier'
  | '/use-mmbai/nodes/template'
  | '/use-mmbai/nodes/tools'
  | '/use-mmbai/nodes/trigger/overview'
  | '/use-mmbai/nodes/trigger/plugin-trigger'
  | '/use-mmbai/nodes/trigger/schedule-trigger'
  | '/use-mmbai/nodes/trigger/webhook-trigger'
  | '/use-mmbai/nodes/user-input'
  | '/use-mmbai/nodes/variable-aggregator'
  | '/use-mmbai/nodes/variable-assigner'
  | '/use-mmbai/publish/README'
  | '/use-mmbai/publish/developing-with-apis'
  | '/use-mmbai/publish/publish-mcp'
  | '/use-mmbai/publish/publish-to-marketplace'
  | '/use-mmbai/publish/webapp/chatflow-webapp'
  | '/use-mmbai/publish/webapp/embedding-in-websites'
  | '/use-mmbai/publish/webapp/web-app-access'
  | '/use-mmbai/publish/webapp/web-app-settings'
  | '/use-mmbai/publish/webapp/workflow-webapp'
  | '/use-mmbai/tutorials/article-reader'
  | '/use-mmbai/tutorials/build-ai-image-generation-app'
  | '/use-mmbai/tutorials/customer-service-bot'
  | '/use-mmbai/tutorials/simple-chatbot'
  | '/use-mmbai/tutorials/twitter-chatflow'
  | '/use-mmbai/tutorials/workflow-101/lesson-01'
  | '/use-mmbai/tutorials/workflow-101/lesson-02'
  | '/use-mmbai/tutorials/workflow-101/lesson-03'
  | '/use-mmbai/tutorials/workflow-101/lesson-04'
  | '/use-mmbai/tutorials/workflow-101/lesson-05'
  | '/use-mmbai/tutorials/workflow-101/lesson-06'
  | '/use-mmbai/tutorials/workflow-101/lesson-07'
  | '/use-mmbai/tutorials/workflow-101/lesson-08'
  | '/use-mmbai/tutorials/workflow-101/lesson-09'
  | '/use-mmbai/tutorials/workflow-101/lesson-10'
  | '/use-mmbai/workspace/api-extension/api-extension'
  | '/use-mmbai/workspace/api-extension/cloudflare-worker'
  | '/use-mmbai/workspace/api-extension/external-data-tool-api-extension'
  | '/use-mmbai/workspace/api-extension/moderation-api-extension'
  | '/use-mmbai/workspace/app-management'
  | '/use-mmbai/workspace/model-providers'
  | '/use-mmbai/workspace/personal-account-management'
  | '/use-mmbai/workspace/plugins'
  | '/use-mmbai/workspace/readme'
  | '/use-mmbai/workspace/subscription-management'
  | '/use-mmbai/workspace/team-members-management'

// UseDify node paths (without prefix)
type ExtractNodesPath<T> = T extends `/use-mmbai/nodes/${infer Path}` ? Path : never
