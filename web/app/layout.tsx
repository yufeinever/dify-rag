  ...
  return (
    <html lang={locale ?? 'en'} className="h-full" suppressHydrationWarning>
      <head>
        ...
        <link rel="apple-touch-icon" href="/apple-touch-icon.png?v=mmb-logo-20260630" />
        <link rel="shortcut icon" href="/favicon.ico?v=mmb-logo-20260630" />
        <link rel="icon" type="image/png" sizes="32x32" href="/icon-192x192.png?v=mmb-logo-20260630" />
        <link rel="icon" type="image/png" sizes="16x16" href="/icon-192x192.png?v=mmb-logo-20260630" />
