...
describe('DifyLogo', () => {
  ...
  describe('Render', () => {
    it('renders correctly with default props', () => {
      render(<DifyLogo />)
      const img = screen.getByRole('img', { name: logoName })
