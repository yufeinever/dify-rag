...
const NoApps: FC = () => {
  ...
  return (
    <div className="rounded-xl bg-background-default-subtle p-4">
      ...
      <a className="system-xs-regular text-text-accent" target="_blank" rel="noopener noreferrer" href={docLink('/use-mmbai/publish/README')}>{t(`${i18nPrefix}.learnMore`, { ns: 'explore' })}</a>
    </div>
  )
}
