          ...
          <div className="flex w-full max-w-[640px] grow flex-col items-center gap-4 pt-6 pb-8">
            <div className="relative flex flex-col items-center gap-[2px] self-stretch py-2">
              ...
              <p className="system-sm-regular text-text-tertiary">
                ...
                <a className="self-stretch system-sm-regular text-text-accent" href={docLink('/use-mmbai/knowledge/connect-external-knowledge-base')} target="_blank" rel="noopener noreferrer">
