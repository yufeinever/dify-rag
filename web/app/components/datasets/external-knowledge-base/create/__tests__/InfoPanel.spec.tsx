...
describe('InfoPanel', () => {
  ...
  describe('Links', () => {
    it('should have correct href for external knowledge API doc link', () => {
      ...
      expect(docLink).toHaveAttribute('href', 'https://docs.dify.ai/use-mmbai/knowledge/external-knowledge-api')
    })

    it('should have correct href for learn more link', () => {
      render(<InfoPanel />)
      const learnMoreLink = screen.getByText(/connectDatasetIntro\.learnMore/)
      expect(learnMoreLink).toHaveAttribute('href', 'https://docs.dify.ai/use-mmbai/knowledge/connect-external-knowledge-base')
    })
