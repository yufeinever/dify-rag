      ...
      <div className="flex w-full min-w-[240px] flex-col items-start gap-3 self-stretch rounded-xl bg-background-section p-6">
        ...
        <p className="flex flex-col items-start gap-2 self-stretch">
          ...
          <span className="system-sm-regular text-text-tertiary">
            ...
            <a className="ml-1 system-sm-regular text-text-accent" href={docLink('/use-mmbai/knowledge/external-knowledge-api')} target="_blank" rel="noopener noreferrer">
          ...
          <a
            ...
            href={docLink('/use-mmbai/knowledge/connect-external-knowledge-base')}
            target="_blank"
